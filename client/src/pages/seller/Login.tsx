...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-emerald-600 via-green-600 to-emerald-900 flex-col items-center justify-center p-12">
        {/* Decorative blobs */}
