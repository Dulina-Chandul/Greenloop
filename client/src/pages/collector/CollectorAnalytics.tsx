      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">
            Track your collection performance and spending
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8">
          <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
            ...
            <p className="text-2xl md:text-3xl font-bold text-white">
              {formatCurrency(stats?.totalSpent || 0, user?.currency)}
            </p>
          </div>
                ...
                >
                  {bidsByStatus?.map((entry: any, index: number) => (
                    <Cell
                      ...
                      fill={
                        BID_STATUS_COLORS[
                          entry._id as keyof typeof BID_STATUS_COLORS
                        ] || "#6b7280"
                      }
                    />
                  ))}
        ...
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700 mb-8">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart
              data={materialBreakdown?.map((item: any) => ({
                category: item._id,
                weight: item.weight,
                spent: item.spent,
              }))}
              ...
              <Bar dataKey="weight" fill="#10b981" name="Weight (kg)">
                {materialBreakdown?.map((entry: any, index: number) => (
                  <Cell
                    ...
                    fill={
                      MATERIAL_COLORS[
                        entry._id as keyof typeof MATERIAL_COLORS
                      ] || "#6b7280"
                    }
                  />
                ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {recentWins?.map((bid: any) => (
              <div
                ...
                className="bg-gray-700 rounded-lg p-4 border border-gray-600 cursor-pointer hover:border-gray-500 transition-colors"
              >
                <img
