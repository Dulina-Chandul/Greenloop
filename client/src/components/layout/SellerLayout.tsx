      ...
      >
        ...
        <div className="p-4 m-4 bg-green-900 border border-green-700 rounded-lg">
          ...
          <p className="text-gray-300 text-xs mb-3">
            Add clear photos to get 40% more bids on your listings!
          </p>
          <Link
            to="/seller/create-listing"
            className="block w-full py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-lg transition-colors text-center"
          >
            Create Listing
          </Link>
        </div>
